...
def load_data(file_path: str) -> pd.DataFrame:
    ...
    try: 
        ...
        logger.error('Unexcepted error ocuured while loading the data: %s', e)
        raise
...
def train_model(X_train: np.ndarray, y_train: np.ndarray, params: dict) ->RandomForestClassifier:
    ...
    :param params: Dictionary of the hyperparameters
    ...
    try:
        ...
        logger.debug("intializing RandomForest_Model with parameters: %s", params)
...
def save_model(model, file_path: str) -> None:
    """
     save the trained model to save_model
