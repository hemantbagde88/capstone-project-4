...
def load_params(param_path: str) -> dict:
    ...
    try:
        ...
        logger.debug('paramters retrived from %s', param_path)
        return params
    except FileNotFoundError:
        logger.error('File is not found: %s', param_path)
        raise
...
def load_data(file_path: str) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error("Unexpexted error occurred while loading the data: %s", e)
        raise 
